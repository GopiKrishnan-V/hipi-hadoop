...
public class Downloader extends Configured implements Tool{
	...
	/**
	 * Mapper class downloads image URL specified in the list.txt
	 */
	...
	/**
	 * Reducer class to combine all the HIPI image bundle file to single HIPI image bundle
	 *
	 */
	...
	/**
	 * Configure the hadoop configurator before running map reduce
	 * @param args
	 * @return
	 * @throws Exception
	 */
	...
	{	
		...
		removeDir(outputFile+"_output", conf);
	...
	/**
	 * Create a directory in file system,
	 * @param path
	 * @param conf
	 * @throws IOException
	 */
